...
document.addEventListener('DOMContentLoaded', function() {
    ...
    displayButton.addEventListener('click', function() {
       ...
       restaurants.forEach(function(restaurant) {
        //I thought it was ...+= '<div class="restaurant.name"></div> for some reason :'/
        //I did get it to output something but it was literally ${restaurant.name}, ${restaurant.cuisine}
        //Finally, I realized late that I was using '' instead of ``
        // `<div>${restaurant.name}</div>, <div>${restaurant.cuisine}</div>` is wrong.
    ...
    filterButton.addEventListener('click', function() {
        ...
        filteredList.innerHTML += `<div>${restaurant.name} - ${restaurant.priceRange}</div>`;
    });
    ...
    mapButton.addEventListener('click', function() {
        ...
        // YOUR CODE HERE:
        const names = restaurants.map(function(restaurant) { return restaurant.name; })
         mappedList.innerHTML = '';
        // I did this originally: mappedList.innerHTML = `<ul><li>${names}</li></ul>`; Yeah that was wrong.
        //How do I get them to be on different lines?
    ...
    findButton.addEventListener('click', function() {
        ...
        foundItem.innerHTML = `${bestRestaurant.name}, ${bestRestaurant.cuisine} - ${bestRestaurant.rating}`;
